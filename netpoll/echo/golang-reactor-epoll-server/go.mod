module iowrapper/netpoll/echo/golang-reactor-epoll-server

go 1.19

require github.com/weedge/lib v0.0.0-20230421075602-62fee9ccade5
...
require (
	...
	github.com/ii64/gouring v0.4.1 // indirect
